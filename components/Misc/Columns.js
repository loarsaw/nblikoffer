        ...
        <div className="-mx-4 flex flex-wrap">
              ...
              <ol>
                <li className="mb-4 flex text-base text-body-color">
                  <span className="relative z-10 mr-2 flex h-6 w-full max-w-[24px] items-center justify-center rounded text-base text-white">
                    <span className="absolute top-0 left-0 z-[-1] h-full w-full -rotate-45 rounded bg-primary"></span>
                    1
                  </span>
                  Lorem ipsum dolor sit amet
                </li>
          ...
          <div className="w-full px-4 lg:w-1/3">
            <div className="mb-12">
              <ul>
                <li className="mb-4 flex text-base text-body-color">
                  <span className="mr-2 rounded-full text-base text-primary">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
          ...
          <div className="w-full px-4 lg:w-1/3">
            <div className="mb-12">
              <ul>
                <li className="mb-4 flex text-base text-body-color">
                  <span className="mr-2 flex items-center text-base text-red-600">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
          ...
          <div className="w-full px-4 lg:w-1/3">
            <div className="mb-12">
              <ul>
                <li className="mb-4 flex text-base text-body-color">
                  <span className="mr-2 flex items-center rounded-full text-base text-primary">
                    <svg
                      width="20"
                      height="8"
                      viewBox="0 0 20 8"
          ...
          <div className="w-full px-4 lg:w-1/3">
            <div className="mb-12">
              <ul>
                <li className="mb-4 flex text-base text-body-color">
                  <span className="mr-2 flex items-center text-base text-primary">
                    <svg
                      width="18"
                      height="18"
                      viewBox="0 0 18 18"
